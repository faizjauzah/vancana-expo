...
<head>
    ...
    <title>Explore Jogja - Kabupaten Gunung Kidul</title>
...
<body>
    ...
    <section id="home" class="jumbotron">
      <div class="d-flex container-fluid" lc-helper="background" style="height:75vh;background-image: linear-gradient(rgba(255, 255, 255, 0.3), rgba(0, 0, 0, 0.5)), url(./img/heha_skyview.jpg);background-position: center;background-repeat: no-repeat;background-size:cover; border-radius: 0px 0px 25px 25px;"></div>
      ...
      <div class="container p-5 bg-hero" onclick="location.href='#destinasi';">
        <div class="row">
          <div class="col-md-6 text-center align-self-center">
            <div class="lc-block">
              <div editable="rich">
                <p class="display-5 text-secondary">ꦒꦸꦤꦸꦁꦏꦶꦢꦸꦭ꧀</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 text-center align-self-center">
            <div class="lc-block">
              <div editable="rich">
                <p class="display-5 fw-bold">Kabupaten Gunung Kidul</p>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12 text-center align-self-center">
            <div class="lc-block mt-5">
              <div editable="rich">
                <p class="lead">Gunung Kidul, Yogyakarta, memukau dengan pantainya yang eksotis seperti Parangtritis dan Indrayanti, serta formasi karst menakjubkan seperti Gua Jomblang. Daerah ini adalah destinasi unggulan bagi pecinta alam dan petualangan yang mencari keindahan alam dan kegiatan outdoor di tengah keberagaman budaya lokal.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="destinasi" class="destinasi ">
      <div class="container ">
        <div class="row text-center mb-3">
          <div class="col">
            <h2>Rekomendasi Destinasi Wisata di Kabupaten Gunung Kidul</h2>
          </div>
        </div>
        <div class="row text-center mb-3">
    ...
    <section id="kuliner" class="kuliner">
      ...
      <div class="container">
        <div class="row text-center mb-3">
          <div class="col">
            <h2>Rekomendasi Kulineran di Kabupaten Gunung Kidul</h2>
          </div>
        </div>
        <div class="row text-center mb-3">
          <div class="col-lg-6 mx-auto">
    ...
    <section class="hotel" id="hotel">
      <div class="row text-center mb-3 ">
        <div class="col">
          <h2>Rekomendasi Hotel di Kabupaten Gunung Kidul</h2>
        </div>
      </div>
      <div class="row text-center mb-3">
        <div class="col-lg-6 mx-auto">
