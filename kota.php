...
<head>
    ...
    <title>Explore Jogja - Kota</title>
...
<body>
      ...
      <div class="container p-5 bg-hero shadow" onclick="location.href='#destinasi';">
        <div class="row">
          <div class="col-md-6 text-center align-self-center">
            <div class="lc-block">
              <div editable="rich">
                <p class="display-5 text-secondary">ꦔꦪꦺꦴꦒꦾꦏꦂꦠ</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 text-center align-self-center">
            <div class="lc-block">
              <div editable="rich">
                <p class="display-5 fw-bold">Kota Yogyakarta</p>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12 text-center align-self-center">
            <div class="lc-block mt-5">
              <div editable="rich">
                <p class="lead">Yogyakarta, sering disebut Jogja, merupakan destinasi pariwisata unggulan di Indonesia dengan daya tarik utama seperti Candi Borobudur dan Candi Prambanan, yang menampilkan warisan budaya yang kaya. Kota ini juga dikenal akan suasana kreatifnya, dengan seni, kerajinan tangan, dan kuliner tradisional yang memikat wisatawan dari seluruh dunia.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="destinasi" class="destinasi ">
      <div class="container ">
        <div class="row text-center mb-3">
          <div class="col">
            <h2>Rekomendasi Destinasi Wisata di Kota Yogyakarta</h2>
          </div>
        </div>
        <div class="row text-center mb-3">
        ...
        <div class="row justify-content-center">
          ...
          <div id="cardCarouselDestinasi" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner hidden">
              ...
              <?php
                $result = mysqli_query($conn, "SELECT * FROM `destinasi` WHERE wilayah_destinasi = 'Kota'");
    ...
    <section id="kuliner" class="kuliner">
      ...
      <div class="container">
        <div class="row text-center mb-3">
          <div class="col">
            <h2>Rekomendasi Kulineran di Kota Yogyakarta</h2>
          </div>
        </div>
        <div class="row text-center mb-3">
          <div class="col-lg-6 mx-auto">
        ...
        <div class="row justify-content-center">
          ...
          <div id="cardCarouselKuliner" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner hidden">
              ...
              <?php
                $result = mysqli_query($conn, "SELECT * FROM `kuliner` WHERE wilayah_kuliner = 'Kota'");
                $numCards = mysqli_num_rows($result);
    ...
    <section class="hotel" id="hotel">
      <div class="row text-center mb-3 ">
        <div class="col">
          <h2>Rekomendasi Hotel di Kota Yogyakarta</h2>
        </div>
      </div>
      <div class="row text-center mb-3">
        <div class="col-lg-6 mx-auto">
          ...
          <div class="row justify-content-center">
            ...
            <div id="cardCarouselHotel5" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner hidden">
                ...
                <?php
                  $result = mysqli_query($conn, "SELECT * FROM `hotel`  WHERE bintang_hotel = 'Bintang 5' && wilayah_hotel = 'Kota'");
                  $numCards = mysqli_num_rows($result);
          ...
          <div class="row justify-content-center">
            <div id="cardCarouselHotel4" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner hidden">
                ...
                <?php
                  $result = mysqli_query($conn, "SELECT * FROM `hotel`  WHERE bintang_hotel = 'Bintang 4' && wilayah_hotel = 'Kota'");
                  $numCards = mysqli_num_rows($result);
        ...
        <div class="container ">
          ...
          <div id="cardCarouselHotel3" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner hidden">
                ...
                <?php
                  $result = mysqli_query($conn, "SELECT * FROM `hotel`  WHERE bintang_hotel = 'Bintang 3' && wilayah_hotel = 'Kota'");
                  $numCards = mysqli_num_rows($result);
