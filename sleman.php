...
<head>
    ...
    <title>Explore Jogja - Kabupaten Sleman</title>
...
<body>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-stick" href="#sleman" role="button" id="navbarDropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">Sleman</a>
                <ul class="dropdown-menu gap-1 p-2 rounded-3 mx-0 shadow w-220px" aria-labelledby="navbarDropdownMenuLink">
                  ...
                  <li><a class="dropdown-item rounded-2" href="sleman.php#khotel">Hotel</a></li>
                  <li><hr class="dropdown-divider"></li>
    ...
    <section id="home" class="jumbotron">
      <div class="d-flex container-fluid" lc-helper="background" style="height:75vh;background-image: linear-gradient(rgba(255, 255, 255, 0.3), rgba(0, 0, 0, 0.5)), url(./img/merapi_park.jpg);background-position: center;background-repeat: no-repeat;background-size:cover; border-radius: 0px 0px 25px 25px;"></div>
      ...
      <div class="container p-5 bg-hero shadow" onclick="location.href='#destinasi';">
        <div class="row">
          <div class="col-md-6 text-center align-self-center">
            <div class="lc-block">
              <div editable="rich">
                <p class="display-5 text-secondary">ꦱ꧀ꦭꦺꦩꦤ꧀</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 text-center align-self-center">
            <div class="lc-block">
              <div editable="rich">
                <p class="display-5 fw-bold">Kabupaten Sleman</p>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12 text-center align-self-center">
            <div class="lc-block mt-5">
              <div editable="rich">
                <p class="lead">Sleman adalah kabupaten yang terletak di Provinsi Daerah Istimewa Yogyakarta, Indonesia. Kabupaten ini terkenal sebagai pusat pendidikan dengan banyak perguruan tinggi ternama, seperti Universitas Gadjah Mada. Sleman juga menawarkan destinasi wisata yang menarik, termasuk Gunung Merapi, Candi Prambanan, dan Kaliurang, yang menawarkan pemandangan alam yang indah dan kegiatan petualangan. Selain itu, Sleman dikenal dengan kearifan lokalnya yang kaya, menciptakan pengalaman budaya yang autentik bagi para pengunjung.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="destinasi" class="destinasi ">
      <div class="container ">
        <div class="row text-center mb-3">
          <div class="col">
            <h2>Rekomendasi Destinasi Wisata di Kabupaten Sleman</h2>
          </div>
        </div>
        <div class="row text-center mb-3">
        ...
        <div class="row justify-content-center">
          ...
          <div id="cardCarouselDestinasi" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner hidden">
              ...
              <?php
                $result = mysqli_query($conn, "SELECT * FROM `destinasi` WHERE wilayah_destinasi = 'Sleman'");
    ...
    <section id="kuliner" class="kuliner">
      ...
      <div class="container">
        <div class="row text-center mb-3">
          <div class="col">
            <h2>Rekomendasi Kulineran di Kabupaten Sleman</h2>
          </div>
        </div>
        <div class="row text-center mb-3">
          <div class="col-lg-6 mx-auto">
        ...
        <div class="row justify-content-center">
          ...
          <div id="cardCarouselKuliner" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner hidden">
              ...
              <?php
                $result = mysqli_query($conn, "SELECT * FROM `kuliner` WHERE wilayah_kuliner = 'Sleman'");
                $numCards = mysqli_num_rows($result);
    ...
    <section class="hotel" id="hotel">
      <div class="row text-center mb-3 ">
        <div class="col">
          <h2>Rekomendasi Hotel di Kabupaten Sleman</h2>
        </div>
      </div>
      <div class="row text-center mb-3">
        <div class="col-lg-6 mx-auto">
          ...
          <div class="row justify-content-center">
            ...
            <div id="cardCarouselHotel5" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner hidden">
                ...
                <?php
                  $result = mysqli_query($conn, "SELECT * FROM `hotel`  WHERE bintang_hotel = 'Bintang 5' &&  wilayah_hotel = 'Sleman'");
                  $numCards = mysqli_num_rows($result);
          ...
          <div class="row justify-content-center">
            <div id="cardCarouselHotel4" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner hidden">
                ...
                <?php
                  $result = mysqli_query($conn, "SELECT * FROM `hotel`  WHERE bintang_hotel = 'Bintang 4' &&  wilayah_hotel = 'Sleman'");
                  $numCards = mysqli_num_rows($result);
        ...
        <div class="container ">
          ...
          <div id="cardCarouselHotel3" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner hidden">
                ...
                <?php
                  $result = mysqli_query($conn, "SELECT * FROM `hotel`  WHERE bintang_hotel = 'Bintang 3' &&  wilayah_hotel = 'Sleman'");
                  $numCards = mysqli_num_rows($result);
