...
<head>
    ...
    <title>Explore Jogja - Bantul</title>
...
<body>
    ...
    <section id="home" class="jumbotron">
      <div class="d-flex container-fluid" lc-helper="background" style="height:75vh;background-image: linear-gradient(rgba(255, 255, 255, 0.5), rgba(0, 0, 0, 0.5)), url(./img/pinus_pengger.jpg);background-position: center;background-repeat: no-repeat;background-size:cover; border-radius: 0px 0px 25px 25px;"></div>
      ...
      <div class="container p-5 bg-hero shadow" onclick="location.href='#destinasi';">
        <div class="row">
          <div class="col-md-6 text-center align-self-center">
            <div class="lc-block">
              <div editable="rich">
                <p class="display-5 text-secondary">ꦧꦤ꧀ꦠꦸꦭ꧀</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 text-center align-self-center">
            <div class="lc-block">
              <div editable="rich">
                <p class="display-5 fw-bold">Kabupaten Bantul</p>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12 text-center align-self-center">
            <div class="lc-block mt-5">
              <div editable="rich">
                <p class="lead">Bantul adalah kabupaten yang terletak di provinsi Daerah Istimewa Yogyakarta, Indonesia. Kabupaten ini dikenal dengan pesona alamnya, termasuk pantai-pantai indah seperti Pantai Parangtritis, serta pesawahan hijau yang menghiasi lanskapnya. Bantul juga terkenal dengan kerajinan tangan, seperti batik dan gerabah, yang mencerminkan kekayaan budaya lokal.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="destinasi" class="destinasi ">
      <div class="container ">
        <div class="row text-center mb-3">
          <div class="col">
            <h2>Rekomendasi Destinasi Wisata di Kabupaten Bantul</h2>
          </div>
        </div>
        <div class="row text-center mb-3">
        ...
        <div class="row justify-content-center">
          ...
          <div id="cardCarouselDestinasi" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner hidden">
              ...
              <?php
                $result = mysqli_query($conn, "SELECT * FROM `destinasi` WHERE wilayah_destinasi = 'Bantul'");
    ...
    <section id="kuliner" class="kuliner">
      ...
      <div class="container">
        <div class="row text-center mb-3">
          <div class="col">
            <h2>Rekomendasi Kulineran di Kabupaten Bantul</h2>
          </div>
        </div>
        <div class="row text-center mb-3">
          <div class="col-lg-6 mx-auto">
        ...
        <div class="row justify-content-center">
          ...
          <div id="cardCarouselKuliner" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner hidden">
              ...
              <?php
                $result = mysqli_query($conn, "SELECT * FROM `kuliner` WHERE wilayah_kuliner = 'Bantul'");
                $numCards = mysqli_num_rows($result);
    ...
    <section class="hotel" id="hotel">
      <div class="row text-center mb-3 ">
        <div class="col">
          <h2>Rekomendasi Hotel di Kabupaten Bantul</h2>
        </div>
      </div>
      <div class="row text-center mb-3">
        <div class="col-lg-6 mx-auto">
          ...
          <div class="row justify-content-center">
            ...
            <div id="cardCarouselHotel5" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner hidden">
                ...
                <?php
                  $result = mysqli_query($conn, "SELECT * FROM `hotel`  WHERE bintang_hotel = 'Bintang 5' && wilayah_hotel = 'Bantul'");
                  $numCards = mysqli_num_rows($result);
          ...
          <div class="row justify-content-center">
            <div id="cardCarouselHotel4" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner hidden">
                ...
                <?php
                  $result = mysqli_query($conn, "SELECT * FROM `hotel`  WHERE bintang_hotel = 'Bintang 4' && wilayah_hotel = 'Bantul'");
                  $numCards = mysqli_num_rows($result);
        ...
        <div class="container ">
          ...
          <div id="cardCarouselHotel3" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner hidden">
                ...
                <?php
                  $result = mysqli_query($conn, "SELECT * FROM `hotel`  WHERE bintang_hotel = 'Bintang 3' && wilayah_hotel = 'Bantul'");
                  $numCards = mysqli_num_rows($result);
