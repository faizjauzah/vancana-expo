        ...
        <div class="row justify-content-center">
          ...
          <div id="cardCarouselDestinasi" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner hidden">
              ...
              <?php
                $result = mysqli_query($conn, "SELECT * FROM `destinasi` WHERE wilayah_destinasi = 'Kulon Progo'");
        ...
        <div class="row justify-content-center">
          ...
          <div id="cardCarouselKuliner" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner hidden">
              ...
              <?php
                $result = mysqli_query($conn, "SELECT * FROM `kuliner` WHERE wilayah_kuliner = 'Kulon Progo'");
                $numCards = mysqli_num_rows($result);
          ...
          <div class="row justify-content-center">
            ...
            <div id="cardCarouselHotel5" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner hidden">
                ...
                <?php
                  $result = mysqli_query($conn, "SELECT * FROM `hotel`  WHERE bintang_hotel = 'Bintang 5' &&  wilayah_hotel = 'Kulon Progo'");
                  $numCards = mysqli_num_rows($result);
          ...
          <div class="row justify-content-center">
            <div id="cardCarouselHotel4" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner hidden">
                ...
                <?php
                  $result = mysqli_query($conn, "SELECT * FROM `hotel`  WHERE bintang_hotel = 'Bintang 4' &&  wilayah_hotel = 'Kulon Progo'");
                  $numCards = mysqli_num_rows($result);
        ...
        <div class="container ">
          ...
          <div id="cardCarouselHotel3" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner hidden">
                ...
                <?php
                  $result = mysqli_query($conn, "SELECT * FROM `hotel`  WHERE bintang_hotel = 'Bintang 3' &&  wilayah_hotel = 'Kulon Progo'");
                  $numCards = mysqli_num_rows($result);
